...
const Wishlist: React.FC<WishlistProps> = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50">
      <div ref={wishlistRef} className="fixed right-0 top-0 h-full w-full max-w-md bg-slate-900 text-white shadow-xl">
        <div className="flex flex-col h-full">
          ...
          <div className="relative py-8 px-6 border-b border-slate-700">
            ...
            <div className="relative flex flex-col items-center">
              <h2 className="text-2xl font-bold text-center mb-2">Wishlist</h2>
          ...
          {/* Footer */}
          {state.items.length > 0 && (
            <div className="border-t border-slate-700 p-6 bg-slate-800/30 backdrop-blur-sm">
              <button 
                onClick={closeWishlist}
