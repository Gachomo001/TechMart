            ...
            <div>
              ...
              <div className="relative w-full">
                ...
                <div className="relative flex justify-between items-center p-4">
                  {/* Facebook */}
                  {facebookUrl && (
                    <a href={facebookUrl} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="relative flex-1 flex justify-center">
                  ...
                  {/* X (Twitter) */}
                  {twitterUrl && (
                    <a href={twitterUrl} target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="relative flex-1 flex justify-center">
                  ...
                  {/* Instagram */}
                  {instagramUrl && (
                    <a href={instagramUrl} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="relative flex-1 flex justify-center">
                  ...
                  {/* WhatsApp */}
                  {whatsappUrl && (
                    <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="relative flex-1 flex justify-center">
