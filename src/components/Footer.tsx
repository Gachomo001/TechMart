...
const Footer: React.FC = () => {
  const { footerLinks, socialMediaLinks, loading, error } = useFooterLinks();
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-blue-400">Raiyaaa</h3>
            ...
            <div>
              ...
              <div className="relative w-full">
                ...
                <div className="relative flex justify-between items-center p-4">
                  {/* Facebook */}
                    <a onClick={() => handleSocialClick(socialMediaLinks.facebook)}className={`relative flex-1 flex justify-center cursor-pointer ${!socialMediaLinks.facebook ? 'opacity-50 cursor-not-allowed' : ''}`}>
                  ...
                  {/* X (Twitter) */}
                    <a onClick={() => handleSocialClick(socialMediaLinks.twitter)}className={`relative flex-1 flex justify-center cursor-pointer ${!socialMediaLinks.twitter ? 'opacity-50 cursor-not-allowed' : ''}`}>
                  ...
                  {/* Instagram */}
                    <a onClick={() => handleSocialClick(socialMediaLinks.instagram)} className={`relative flex-1 flex justify-center cursor-pointer ${!socialMediaLinks.instagram ? 'opacity-50 cursor-not-allowed' : ''}`}>
                  ...
                  {/* WhatsApp */}
                   <a onClick={() => handleSocialClick(socialMediaLinks.whatsapp)} className={`relative flex-1 flex justify-center cursor-pointer ${!socialMediaLinks.whatsapp ? 'opacity-50 cursor-not-allowed' : ''}`}>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">{import.meta.env.VITE_CONTACT_PHONE || '+254 796 714113'}</span>
              </div>
              <div className="flex items-center space-x-3">
